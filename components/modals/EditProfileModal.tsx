...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({ onClose, onUpdateComplete, initialData }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // 3. Update Firebase Auth Profile (for consistency across app)
            if (auth.currentUser) {
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="relative group cursor-pointer">
                            ...
                            />
                            <div className="w-24 h-24 rounded-full border-4 border-slate-100 dark:border-white/5 shadow-inner overflow-hidden relative">
                        ...
                        <p className="text-xs text-slate-400 mt-2">Tap to change avatar</p>
                    </div>
